...
function outputPostRow($number)  {
    ...
    echo "<div class=\"row\">
                        <div class=\"col-md-4\">
            ".
        generateLink("post.php?id=$number", "<img src=images/{${'thumb'.$number}} alt={${"title".$number}} class=img-responsive/>", "")
        .
        "</div>
          <div class=\"col-md-8\">
             <h2>{${"title".$number}}</h2>
             <div class=\"details\">Posted by ".generateLink("user.php?id={${"userId".$number}}","{${"userName".$number}}","").
