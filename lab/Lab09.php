...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              asort($countries);
              foreach($countries as $elements){
                  echo '<a href="list.php?country='.$elements.' role="button" class="btn btn-default">'. $elements.'</a>';
              }
              ?>
          ...
          foreach($images as $key=>$element) {
              ...
              '<li>
                 <a href="detail.php?id='.$key.'"class="img-responsive">
                 	<img src="images/square/'.$element["path"].'" alt="View of Cologne">
                 	<div class="caption">
                 		<div class="blur">
                 		</div>
