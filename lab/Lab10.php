          ...
          <div class="panel-body">
            <form action="Lab10.php" method="get" class="form-horizontal">
              ...
              <select name="continent" class="form-control">
                ...
                $questContinents = 'SELECT * FROM continents';
                $result=$mysqli->query($questContinents);
              ...
              <select name="country" class="form-control">
                ...
                $questCountries = "SELECT * FROM countries";
                $result=$mysqli->query($questCountries);
                while($row = $result->fetch_assoc()) {
            ...
            */
                ...
                if($continent==""||$continent=="0"){
                    if($country==""||$country=="0"){
                        ...
                        //$sql ="SELECT * FROM ImageDetails WHERE CountryCodeISO='".$country."'"; echo "2";
